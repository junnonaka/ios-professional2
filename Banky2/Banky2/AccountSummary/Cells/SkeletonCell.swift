...
extension SkeletonCell{
    ...
    //GradientLayerを各要素の上に被せる
    private func setupLayer(){
        //startPoint、endPointはGradientLayerの開始点と終点を表している。但しアニメーションさせるので初期値のようなもの
    ...
    private func setupAnimation(){
        ...
        //順番にアニメーションが実行されるようにするためにpreviousgroupに入れる
